...
#define RST_PIN 2 // You can connect the RST pin to a free GPIO, e.g., GPIO2 (D4)
#define SCK_PIN 14 // SCK connected to GPIO14 (D5)
#define MOSI_PIN 13 // MOSI connected to GPIO13 (D7)
#define MISO_PIN 12 // MISO connected to GPIO12 (D6)

Rfid rfid(SS_PIN, RST_PIN);  // Create an instance of the Rfid class
